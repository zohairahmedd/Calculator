...
root.configure(bg="#000000") # sets background colour for main window

e = Entry(root, width=22, borderwidth=2, bg="#000000", fg="white", font=("Helvetica", 22, "bold")) # defines characteristics of widget e - characteristics inside the window
...
button_1 = Button(root, text='1',bg="#404040",fg="white", padx=40, pady=20, command=lambda: button_click(1))
button_2 = Button(root, text='2',bg="#404040",fg="white", padx=43, pady=20, command=lambda: button_click(2))
button_3 = Button(root, text='3',bg="#404040",fg="white", padx=48, pady=20, command=lambda: button_click(3))
button_4 = Button(root, text='4',bg="#404040",fg="white", padx=40, pady=20, command=lambda: button_click(4))
button_5 = Button(root, text='5',bg="#404040",fg="white", padx=43, pady=20, command=lambda: button_click(5))
button_6 = Button(root, text='6',bg="#404040",fg="white", padx=48, pady=20, command=lambda: button_click(6))
button_7 = Button(root, text='7',bg="#404040",fg="white", padx=40, pady=20, command=lambda: button_click(7))
button_8 = Button(root, text='8',bg="#404040",fg="white", padx=43, pady=20, command=lambda: button_click(8))
button_9 = Button(root, text='9',bg="#404040",fg="white", padx=48, pady=20, command=lambda: button_click(9))
button_0 = Button(root, text='0',bg="#404040",fg="white", padx=91, pady=20, command=lambda: button_click(0))
button_dot = Button(root, text='.',bg="#404040",fg="white", padx=49, pady=20, command=lambda: button_click('.'))
button_add = Button(root, text='+',bg="#d47f11",fg="white", padx=40, pady=20, command= button_add)
button_equal = Button(root, text='=',bg="#d47f11",fg="white", padx=90, pady=20, command= button_equal)
button_clear = Button(root, text='AC',bg="#d47f11",fg="white", padx=91, pady=20, command= button_clear)
button_subtract = Button(root, text='-',bg="#d47f11",fg="white", padx=42, pady=20, command= button_subtract)
button_multiply = Button(root, text='*',bg="#d47f11",fg="white", padx=42, pady=20, command= button_multiply)
button_divide = Button(root, text='/',bg="#d47f11",fg="white", padx=42, pady=20, command= button_divide)

# positions number buttons at a specific location in the grid defined by row and column parameters
...
# positions operation buttons at a specific location in the grid defined by row and column parameters
