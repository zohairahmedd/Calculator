...
e.grid(row=0, column=0, columnspan=3, padx=4, pady=5, ipadx=8, ipady=13) # places widget inside the main window with padding
...
button_dot = Button(root, text='.',bg="#4a503d",fg="white", padx=41, pady=20, command=lambda: button_click('.'))
...
button_clear = Button(root, text='AC',bg="#4a503d",fg="white", padx=35, pady=20, command= button_clear)
